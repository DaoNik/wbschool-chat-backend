...
- обязательное поле ownerAvatar в который передаётся avatar пользователя создающего чат 
- обязательное поле ownerFormatImage в который передаётся formatImage пользователя создающего чат
